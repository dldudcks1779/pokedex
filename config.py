...
# GPIO 핀 번호 (BCM)
BATTERY_GREEN_LED_PIN = 13  # 초록색 LED (배터리 70% 이상)
BATTERY_YELLOW_LED_PIN = 19 # 노란색 LED (배터리 30% 이상)
BATTERY_RED_LED_PIN = 26    # 빨간색 LED (배터리 0% 이상)
PLAY_LED_PIN = 16           # 재생 상태 LED
BUTTON_PIN = 20             # 버튼

# 배터리 임계값 (%)
BATTERY_THRESHOLD_HIGH = 70.0 # 배터리 잔량 높은 기준
BATTERY_THRESHOLD_LOW = 30.0  # 배터리 잔량 낮은 기준
