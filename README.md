...
- **Circuit Diagram**<br>
    <img src="./resources/images/circuit_diagram.png" alt="Circuit Diagram" width="50%">
...
- **Machine Learning**
    ...
    - **Datasets**
        ...
        - **Path:** `datasets/`
    - **Confusion Matrix**        
        <img src="./resources/images/confusion_matrix.png" alt="Confusion Matrix" width="50%">    
    - **Performance Metrics**
        - **Accuracy**<br>
            <img src="./resources/images/accuracy.png" alt="Accuracy" width="50%">
        - **Loss**<br>
            <img src="./resources/images/loss.png" alt="Loss" width="50%">
    - **Files Included**
...
- **Interfaces**    
    <img src="./resources/images/interfaces.png" alt="Circuit Diagram" width="50%">
    - **SSH Enabled**
    - **VNC (Virtual Network Computing) Enabled**
    - **SPI (Serial Peripheral Interface) Enabled**
    - **I2C (Inter-Integrated Circuit) Enabled**

### 3) Display Settings (MHS 3.2" TFT Touch Display)
